...
<header id="header">
        <div id="div_header">
            ...
            <ul id="ul_header">
                ...
                <li><a href="../view/pageFornecedor.php?op=cadastrarFornecedor">Cadastrar forncedor</a></li>
            </ul>
        </div>
</header>
...
<?php
        ...
        if($qtd>0){
            ...
            print "<th> Fornecedores &nbsp </th>";
            print "<th> Cliente desde &nbsp</th>";
            print "</tr>";
            while ($row = $res->fetch(PDO::FETCH_OBJ)){
                ...
                print "<td>".$row->fornecedores."</td>";
                print "<td>".$row->clienteDesde."</td>";
                print "<td>
                <button onclick=\"location.href ='../view/pageCliente.php?op=alterarCliente&id=".$row->id."';\">Alterar</button>
                <button onclick=\"if(confirm('Tem certeza que deseja excluir?')){
                    location.href = '../controller/processa.php?op=excluirCliente&id=".$row->id."'; }
