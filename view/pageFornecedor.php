...
<?php
    ...
    if($operacao=="alterarFornecedor") {
        include "../controller/fornecedorController.php";
        $res = fornecedorController::resgataFornecedor($_REQUEST["id"]);
        $qtd = $res->rowCount();
    ...
    print "<label for='clientes'>CLIENTES:</label>";
    print "<input type='text' name='clientes' value=".$clientes."><br>";
    print "<label for='produtos'>PRODUTOS:</label>";
    print "<input type='text' name='produtos' value=".$produtos."><br>";
